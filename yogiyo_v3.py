...
def yogiyo_crawling(location, food_category):
    ...
    print(store_list)
    try:
        for i in tqdm(range(5,len(store_list)+1)):
            ...
            while True:
                ...
                try:
                    ...
                    dates = driver.find_element_by_xpath("// *[ @ id = 'review'] / li[" + str(idx) + "] / div[1] / span[2]").text
            ...
            for review in reviews:
                ...
                row = pd.DataFrame([(address.split(" ")[0], address.split(" ")[1], food_category, store_name, year, month,
...
def main():
    ...
    for category in categories:
        ...
        yogiyo_crawling('서울특별시 중구 창경궁로 17 중구청', category)
